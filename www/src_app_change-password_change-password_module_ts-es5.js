  ...
  (self["webpackChunkgas"] = self["webpackChunkgas"] || []).push([["src_app_change-password_change-password_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _ChangePasswordPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _change_password_routing_module__WEBPACK_IMPORTED_MODULE_0__.ChangePasswordPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ChangePasswordPage = /*#__PURE__*/function () {
        function ChangePasswordPage(router, network) {
        ...
        _createClass(ChangePasswordPage, [{
          ...
          key: "change_passowrd",
          value: function change_passowrd(o, n, cn) {
            var _this = this;
            ...
            if (!o || !n || !cn) {
              ...
              this.network.change_passowrd(data).subscribe(function (res) {
                console.log("SUCCESS ===", res);

                if (res == 'old') {
                  _this.bres = 'Your current password is wrong';
                } else if (res == 'new') {
                  _this.bres = 'Your current passwords do not match';
                } else if (res == 'success') {
                  _this.gres = 'You changed admin password successfully!';
                }
              }, function (error) {
      ...
      _ChangePasswordPage = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
